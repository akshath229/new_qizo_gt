...
class ReceiptCollections extends StatefulWidget {
  ...
  int passvalue;
  dynamic passname;
   ReceiptCollections({required this.passvalue,this.passname});
...
//  var _dobController = TextEditingController();
  ...
  List<ReceiptAdd> customerReceipts =[];
  List<ReceiptAdd> finalCustomerReceipts = [];
...
//get customer ledger balance
  ...
  Future<bool> _onBackPressed() {
    Navigator.pop(context);
    return Future.value(false); // You are handling the back button, so return false.
  }
