...
class Payment_Voucher_Direct extends StatefulWidget {
  ...
  int passvalue;
  dynamic passname;
  Payment_Voucher_Direct({required this.passvalue,this.passname});
...
var BtnName="Save";
  ...
  GetVchnum()async{
    ...
    try {
      final tagsJson =
      await http.get("${Env.baseUrl}getSettings/1/paymentvoucher" as Uri, headers: {
...
//     );
    ...
    var res = await http.post("${Env.baseUrl}taccpaymentheaders" as Uri,
        headers: {
...
//--------------------------Edit part----------------------------------
  ...
  EditBinde(id)async{
    ...
    print("uiouiouioiu");
    print(id.toString());
    var res = await http.get("${Env.baseUrl}taccpaymentheaders/$id" as Uri,
        headers: {
          'accept': 'application/json',
          'content-type': 'application/json',
          'Authorization': user.user["token"],
...
//            content: Text("$customerName"),
    ...
    var map = json.encode(req);
    print(map);
    var res = await http.put("${Env.baseUrl}taccpaymentheaders/${widget.passvalue}" as Uri,
        headers: {
          'accept': 'application/json',
          'content-type': 'application/json',
          'Authorization': user.user["token"],
...
class Receipt_Payment_Add {
  ...
  Receipt_Payment_Add({this.slNo,required this.receivedAmount,required this.remarks,
