...
class Ofline_Sales extends StatefulWidget {
  ...
  int passvalue;
  dynamic passname;
  Ofline_Sales({required this.passvalue,this.passname,this.itemrowdata});
...
//   befortax=taxOneItm*double.parse(quantityController.text);
  ...
  Future<bool> _onBackPressed() async {
    // If you want to ask the user for confirmation before popping the screen,
    // you can add your logic here (e.g., show a dialog) and return false if
    // the user chooses not to close the screen.

    customerItemAdd.clear();
    Resetfunction();

    // If you've decided to pop the screen:
    Navigator.pop(context);

    return Future.value(false); // This will prevent the screen from being popped again.
  }
